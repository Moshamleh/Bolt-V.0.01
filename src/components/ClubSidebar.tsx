...
import { 
  Users, Plus, MessageSquare, Home, 
  UserPlus, Settings, X, Heart
} from 'lucide-react';
...
const ClubSidebar: React.FC<ClubSidebarProps> = ({ isOpen, onClose }) => {
  return (
    <>
      {/* Mobile Overlay */}
      {isOpen && (
      ...
      >
        <div className="p-4 border-b border-neutral-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-white">Clubs</h2>
            <button
              onClick={onClose}
