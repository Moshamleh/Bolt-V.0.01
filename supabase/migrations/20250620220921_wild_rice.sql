...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE p.polname = 'Club members can read messages' 
    AND c.relname = 'club_messages'
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Club members can send messages' 
    AND c.relname = 'club_messages'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Admins can read reports' 
    AND c.relname = 'reported_parts'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can report parts' 
    AND c.relname = 'reported_parts'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Anyone can read seller reviews' 
    AND c.relname = 'seller_reviews'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can create reviews as buyers' 
    AND c.relname = 'seller_reviews'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can update their own reviews' 
    AND c.relname = 'seller_reviews'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can delete their own reviews' 
    AND c.relname = 'seller_reviews'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Admins can manage all reviews' 
    AND c.relname = 'seller_reviews'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Enable read access for all users' 
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can read their own challenge progress' 
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can update their own challenge progress' 
    AND c.relname = 'user_challenges'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can insert their own challenge progress' 
    AND c.relname = 'user_challenges'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can read own boost orders' 
    AND c.relname = 'boost_orders'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can create boost orders' 
    AND c.relname = 'boost_orders'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can update own boost orders' 
    AND c.relname = 'boost_orders'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Service role can update boost orders' 
    AND c.relname = 'boost_orders'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Service role can insert boost orders' 
    AND c.relname = 'boost_orders'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Service role can read boost orders' 
    AND c.relname = 'boost_orders'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can access only their own login data' 
    AND c.relname = 'user_logins'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can insert their own login data' 
    AND c.relname = 'user_logins'
    AND n.nspname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    JOIN pg_class c ON p.polrelid = c.oid
    JOIN pg_namespace n ON c.relnamespace = n.oid
    WHERE p.polname = 'Users can read their own login data' 
    AND c.relname = 'user_logins'
    AND n.nspname = 'public'
  ) THEN
